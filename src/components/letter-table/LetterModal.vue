    ...
    <div v-if="modelValue" class="fixed inset-0 z-50 overflow-hidden" aria-labelledby="modal-title" role="dialog" aria-modal="true">
      ...
      <div class="flex items-center justify-center min-h-screen p-4">
        <div class="relative bg-white rounded-xl shadow-2xl w-[90%] h-[90vh] max-w-[1300px] overflow-hidden">
          ...
          <!-- <template>
            <div class="bg-white px-6 py-4 border-b z-10">
              <client-only>
          ...
          <!-- Remove all previous content sections -->
                <div class="h-full overflow-y-auto pt-20 px-8 pb-8 bg-gray-50">
                  <div class="bg-white rounded-xl shadow-sm p-8">
                    ...
                    <!-- Content section with mavon-editor -->
                    <div class="flex items-start gap-4 mt-6">
                        <label class="font-medium w-24 text-lg">Content:</label>
                        <div class="flex-1">
                            <mavon-editor
                            ...
                            <div v-if="errors.content" class="flex justify-center mt-2">
                                <ValidationWarning :message="errors.content" />
                            </div>
                        </div>
                    </div>
...
/* Move these styles inside the style block */
.tooltip-container {
  position: relative;
}
...
export default {
  ...
  components: {
    SuccessMessageModal,
    ValidationWarning
    // Remove mavonEditor from here since it's globally registered
  },
  props: {
    modelValue: {
      type: Boolean,
  ...
  setup(props, { emit }) {
    ...
    // Define editorOptions here
    const editorOptions = {
      // Add your desired mavon-editor options here, or leave empty for defaults
    };

    return {
      ...letterModal,
      editorOptions // Make sure this is returned
    }
  }
}
</script>
